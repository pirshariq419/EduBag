      ...
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-16 space-y-4">
          ...
          <h1 className="text-5xl font-black text-slate-900 dark:text-white tracking-tight">
            Terms of <span className="text-indigo-600 dark:text-indigo-500">Service</span>
          </h1>
        ...
        >
          <section className="space-y-4">
            ...
            <p className="text-slate-600 dark:text-slate-400 leading-relaxed font-medium">
              By accessing or using EduBag, you agree to be bound by these Terms of Service. If you do not agree to all of these terms, do not use our services.
            </p>
          </section>
          ...
          <section className="space-y-4">
            ...
            <p className="text-slate-600 dark:text-slate-400 leading-relaxed font-medium">
              You are responsible for maintaining the confidentiality of your account credentials. You must provide accurate and complete information when creating an account. EduBag reserves the right to terminate accounts that violate our community guidelines.
            </p>
          </section>
          ...
          <section className="space-y-4">
            ...
            <p className="text-slate-600 dark:text-slate-400 leading-relaxed font-medium">
              The content provided on EduBag, including but not limited to notes, exam patterns, and mock test questions, is the property of EduBag or its content creators. You are granted a limited, non-exclusive license to access this content for personal, non-commercial educational use only.
            </p>
          </section>
          ...
          <div className="pt-8 border-t border-slate-100 dark:border-white/5 text-center">
            <p className="text-sm text-slate-500 font-medium">
              Questions about our Terms? <a href="/contact" className="text-indigo-600 hover:underline">Contact us</a>.
            </p>
          </div>
        </motion.div>
      </div>
